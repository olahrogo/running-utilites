...
<div class="bg-white shadow-md rounded-lg p-6">
  <h1 class="text-xl font-bold mb-4">Tinman Running Calculator</h1>
  <p class="mb-4 text-gray-600">Calculate equivalent race times and training paces based on Tom Schwartz's Critical Velocity (CV) methodology.</p>
              ...
              {#each Object.entries(calculatedPaces.equivalent_races) as [distance, time]}
                <tr>
                  <td class="py-2 px-4 border-b border-gray-200">
                    {tinmanDistanceOptions.find(option => option.value === distance)?.label || distance}
                  </td>
